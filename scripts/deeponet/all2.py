...
def run_pipeline(grid, seed, cytokine):
    ...
    out_dir   = Path("./models_200h/deeponet_h"); out_dir.mkdir(parents=True, exist_ok=True)
    ...
    results = {
        ...
        "results": {
            "Near_Horizon_t162_t181": calculate_metrics(
                Y_phys[160:180], Yp_phys[160:180], M[160:180], clip_max),
            "Far_Horizon_t182_t200": calculate_metrics(
                Y_phys[180:199], Yp_phys[180:199], M[180:199], clip_max),
        },
    }
